...
public class ChatWithStrangerDialogFragment  extends DialogFragment {
    ...
    private final com.qiscus.chat.sample.ui.privatechatcreation.ChatWithStrangerDialogFragment.onStrangerNameInputtedListener listener;

    @SuppressLint("ValidFragment")
    public ChatWithStrangerDialogFragment(com.qiscus.chat.sample.ui.privatechatcreation.ChatWithStrangerDialogFragment.onStrangerNameInputtedListener listener) {
